...
class ContentParser:
    def __init__(self):
        ...
        self.xc_functional_mapping = {
            ...
            'TPSS_X': ['MGGA_X_TPSS'],
            'TPSS_C': ['MGGA_C_TPSS'],
            'RTPSS': ['MGGA_X_RTPSS', 'MGGA_C_RTPSS'],
            'RTPSS_X': ['MGGA_X_RTPSS'],
            'RTPSS_C': ['MGGA_C_RTPSS'],
            'M06L': ['MGGA_X_M06_L', 'MGGA_C_M06_L'],
            'M06L_X': ['MGGA_X_M06_L'],
            'M06L_C': ['MGGA_C_M06_L'],
            'MS0': ['MGGA_X_MS0', 'MGGA_C_MS0'],
            'MS0_X': ['MGGA_X_MS0'],
            'MS0_C': ['MGGA_C_MS0'],
            'MS1': ['MGGA_X_MS1', 'MGGA_C_MS1'],
            'MS1_X': ['MGGA_X_MS1'],
            'MS1_C': ['MGGA_C_MS1'],
            'MS2': ['MGGA_X_MS2', 'MGGA_X_MS2'],
            'MS2_X': ['MGGA_X_MS2'],
            'MS2_C': ['MGGA_C_MS2'],
            ...
            'RSCAN_X': ['MGGA_X_RSCAN'],
            'RSCAN_C': ['MGGA_C_RSCAN'],
